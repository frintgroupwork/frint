      ...
      <Section className="flex flex-row w-[90%] items-center justify-between mx-auto py-5">
        <div className="flex flex-col gap-4 max-md:pt-4">
          <p className="text-4xl font-medium text-neutral-800 max-lg:text-2xl whitespace-normal">
            ...
            <span className="text-[#1d4ed8]">RIGHT HERE!</span>{" "}
          </p>
          <p className="text-lg text-neutral-600 max-lg:text-sm whitespace-normal w-3/4">
            Explore and being well prepare of your interview to secure your job
          </p>
          <div className="flex gap-4">
            <Button color="primary" onClick={handleNavigation}>Get Started</Button>
            <Link
              isExternal
              showAnchorIcon
